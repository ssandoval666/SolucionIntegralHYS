#pragma checksum "C:\Users\sebastian\Desktop\SolucionHYS\WebAppSmartDS\WebAppSmartDS\Views\Plugins\Bootbox.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "1bf56344ca180863452dd5510da160e45303ba45eb1ead02cd9dd76bd7aaae62"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCoreGeneratedDocument.Views_Plugins_Bootbox), @"mvc.1.0.view", @"/Views/Plugins/Bootbox.cshtml")]
...
#nullable disable
    ...
    #line default
    #line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"Sha256", @"1bf56344ca180863452dd5510da160e45303ba45eb1ead02cd9dd76bd7aaae62", @"/Views/Plugins/Bootbox.cshtml")]
    ...
    #nullable restore
    internal sealed class Views_Plugins_Bootbox : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\sebastian\Desktop\SolucionHYS\WebAppSmartDS\WebAppSmartDS\Views\Plugins\Bootbox.cshtml"
   
	ViewData["Title"] = "BootBox";
	ViewData["PageName"] = "plugins_bootbox";
	ViewData["Category1"] = "Core Plugins";
	ViewData["Heading"] = "<i class='subheader-icon fal fa-shield-alt'></i> BootBox <sup class='badge badge-success fw-500'>EXTENSION</sup>";
	...
	<div class=""col-xl-1");
		...
		<div id=""panel-1"" class=""panel"">
						...
						<tbody>
							<tr>
								<td style=""width: 40%; vertical-align: middle;"">
									<span class=""d-inline-flex bord");
            WriteLiteral(@"er border-primary text-primary width-1 height-1 rounded-circle fw-500 mr-2 align-items-center justify-content-center"">1</span> Basic usage
								</td>
								<td>
            ...
            WriteLiteral(@"</td>
							...
							<tr>
								<td sty");
            WriteLiteral(@"le=""width: 40%; vertical-align: middle;"">
							...
							<tr>
								<td style=""width: 40%; vertical-align: middle;"">
									<span class=""d-inline-flex border border-primary text-primary width-1 height-1 rounded-c");
            WriteLiteral(@"ircle fw-500 mr-2 align-items-center justify-content-center"">8</span>
							...
							<tr>
								...
								<td>
									<a href=""javascript");
            WriteLiteral(@":void(0);"" class=""btn btn-outline-primary"" id=""js-bootbox-example-10"">Try me!</a>
								</td>
							</tr>
							<tr>
								<td style=""width: 40%; vertical-align: middle;"">
							...
							<tr>
							");
            WriteLiteral(@"	<td style=""width: 40%; vertical-align: middle;"">
							...
							<tr>
								<td style=""width: 40%; vertical-align: middle;"">
									<span class=""d-inline-flex border border-primary text-primary width-1 height-1 rounded-circle fw-500 mr-2 al");
            WriteLiteral(@"ign-items-center justify-content-center"">15</span>
            ...
            WriteLiteral(@"tn btn-outline-primary"" id=""js-bootbox-example-17"">Try me!</a>
								</td>
							</tr>
							<tr>
								<td style=""width: 40%; vertical-align: middle;"">
							...
							<tr>
								<td style=""width: 40%; vertical-align: middle;"">
							");
            WriteLiteral(@"		<span class=""d-inline-flex border border-primary text-primary width-1 height-1 rounded-circle fw-500 mr-2 align-items-center justify-content-center"">20</span>
									Prompt with range
								</td>
								<td>
							...
							<tr>
								<td style=""width: 40%; vertical-align: middle;"">
									<span class=""d-inline-flex border border-primary text-primary width-1 height-1 rounded-circle fw-500 mr-2 align-items-center justify-content-center"">");
            ...
            WriteLiteral(@"=""btn btn-outline-primary"" id=""js-bootbox-example-24"">Try me!</a>
								</td>
							</tr>
						</tbody>
					</table>
		...
		<div id=""panel-2"" class=""panel"">
			...
			<div class=""panel-container show"">
				<div class=""panel-content"">									
					<div class=""panel-tag"">
						Below we use the custom class method <code>className</code> to add the class <code>modal-alert</code> to change the dialog ap");
            WriteLiteral(@"pearance and also add sound by using <code>initApp.playSound</code> function
					</div>
					<table class=""table table-bordered table-hover"">
						<tbody>
							<tr>
	...
	<script>
		$(document).ready(function () {
			...
			$(""#js-bootbox-example-6"").on(""click"", function () {
				bootbox.alert({
					message: ""This");
                WriteLiteral(@" alert can be dismissed by clicking on the background!"",
					backdrop: true
				});
			}); 
			...
			$(""#js-bootbox-example-9"").on(""click"", function () {
				bootbox.confirm({
					...
					buttons: {
						cancel: {
							label: '<i class=""fa fa-tim");
                WriteLiteral(@"es""></i> Cancel'
						},
						confirm: {
			...
			$(""#js-bootbox-example-15"").on(""click"", function () {
				bootbox.prompt({
					title: ""This is a prompt wi");
                WriteLiteral(@"th a password input!"",
					inputType: 'password',
					callback: function (result) {
						console.log(result);
					}
			...
			$(""#js-bootbox-example-21"").on(""click"",");
					  ...
					  buttons: {
						success: {
						  ...
						  callback: function () {
							...
							console.log(""Hel");
                WriteLiteral("lo \" + name + \". You\'ve chosen \" + answer + \"\")\n\t\t\t\t\t\t  }\n\t\t\t\t\t\t}\n\t\t\t\t\t  }\n\t\t\t\t\t}\n\t\t\t\t);\n\t\t\t}); \n\t\t\t$(\"#js-bootbox-alert-1\").on(\"click\", function () {\n\t\t\t\tinitApp.playSound(\'media/sound\', \'bigbox\')\n\t\t\t\tbootbox.confirm({\n\t\t\t\t\ttitle: \"<i class=\'");
                Write(
#nullable restore
#line 651 "C:\Users\sebastian\Desktop\SolucionHYS\WebAppSmartDS\WebAppSmartDS\Views\Plugins\Bootbox.cshtml"
...
#nullable disable
                ...
                WriteLiteral(@" fa-times-circle text-danger mr-2'></i> Do you wish to delete this table?"",
			...
			$(""#js-bootbox-alert-2"").on(""click"", function () {
                ...
                Write(
#nullable restore
#line 675 "C:\Users\sebastian\Desktop\SolucionHYS\WebAppSmartDS\WebAppSmartDS\Views\Plugins\Bootbox.cshtml"
                         Settings.Theme.IconPrefix
...
#nullable disable
                ...
                WriteLiteral(@" fa-check-circle text-success mr-2'></i> <span class='text-success fw-500'>Success!</span>"",
